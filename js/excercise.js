...
(function onLoad()
{
    ...
    getBodyPartExcercise();
})();

function setButtonFunctions()
{
    document.getElementById('button-bodyPart-Excercise').onclick = getBodyPartExcercise;

}

// Body Fat % calculator
async function getBodyPartExcercise()
{
...
.then(response => {
    console.log("Given Excercises (from specific Body Part):");
