...
(function onLoad()
{
    ...
    getTargetMusclesExcercise();
})();

function setButtonFunctions()
{
    document.getElementById('button-targetMuscles-Excercise').onclick = getTargetMusclesExcercise;
}

// Body Fat % calculator
async function getTargetMusclesExcercise()
{
    document.getElementById('excercise-result').innerHTML = "";
    document.getElementById('number-of-excercises').innerHTML = "";
    const targetMuscles = document.getElementById('targetMuscles').value;
    
    fetch("https://exercisedb.p.rapidapi.com/exercises/target/" + targetMuscles, {
	"method": "GET",
	"headers": {
...
.then(response => {
    console.log("Given Excercises (from specific Target Muscle):");
